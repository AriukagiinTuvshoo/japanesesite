...
(function(){
 ...
 window.AIActions={ACTIONS:ACTIONS,parseAndValidate:function(text){var parsed=parseJsonMaybe(text);return parsed?validate(parsed):{valid:false,error:'no_structured_action',rawText:asText(text)};},validate:validate,itemExists:itemExists};
})();